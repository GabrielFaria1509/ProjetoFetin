...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get register_success => '账户创建成功';

  @override
  String get logout => '退出';

  @override
  String get logout_confirm => '您确定要退出吗？';

  @override
  String get participant => '参与者';

  @override
  String get participant_desc => 'TISM普通用户';

  @override
  String get responsible => '负责人';

  @override
  String get responsible_desc => '家庭成员或照护者';

  @override
  String get professional => '专业人士';

  @override
  String get professional_desc => '治疗师、医生、教育者';

  @override
  String get user_type => '用户类型';

  @override
  String get select_user_type => '选择您的类型';
  ...
  @override
  String get edit_username => '编辑用户名';
  ...
  @override
  String get system_theme => '系统';

  @override
  String get system_theme_desc => '跟随设备主题';
  ...
  @override
  String get personalized_routine => '个性化日程';

  @override
  String get custom_routine => '自定义日程';

  @override
  String get observation_diary => '观察日记';

  @override
  String get tina_chatbot => '蒂娜（聊天机器人）';

  @override
  String get tea_forum => '自闭症论坛';

  @override
  String get articles => '文章';

  @override
  String get digital_library => '数字图书馆';

  @override
  String get new_post => '新帖子';

  @override
  String get publish => '发布';

  @override
  String get share_experience => '分享您关于自闭症的经验、疑问或建议...';

  @override
  String get write_something => '发布前请写点什么';

  @override
  String get confirm_publication => '确认发布';

  @override
  String get want_to_publish => '您想在论坛发布这个帖子吗？';
  ...
  @override
  String get type_message => '输入您的消息...';

  @override
  String get about_tina => '💙 关于蒂娜';
  ...
  @override
  String get tap_plus_start => '点击+开始';
  ...
  @override
  String get crisis => '危机';

  @override
  String get difficulty => '困难';

  @override
  String get triggers => '触发因素';
  ...
  @override
  String get no_articles_found => '未找到文章';

  @override
  String get no_articles_available => '没有可用文章';

  @override
  String get article_early_signs_title => '自闭症的早期征象：需要注意的事项';

  @override
  String get article_early_signs_body =>
      '自闭症谱系障碍（ASD）的早期诊断对儿童发展极为重要。最初的征象可能在生命的最初几个月就出现。主要指标包括：社交沟通困难，如避免目光接触、不回应名字或不指向有趣的物体；重复性行为模式，如手部刻板动作或专注于特定物体；感觉敏感性，对声音、触觉或光线反应过度或不足；语言发展延迟，包括12个月时没有呀呀声或16个月时没有词语。重要的是要记住，每个孩子都是独特的，可能表现出这些征象的不同组合。如果您注意到这些行为中的一些，请寻求合格专家的指导以进行适当的评估。';

  @override
  String get article_early_signs_author => '安娜·西尔瓦博士 - 儿童神经学家';

  @override
  String get article_aba_therapy_title => '应用行为分析（ABA）：原理和益处';

  @override
  String get article_aba_therapy_body =>
      '应用行为分析（ABA）是针对自闭症患者的最具研究和有效的干预措施之一。基于行为的科学原理，ABA使用系统性技术来教授技能和减少问题行为。主要组成部分包括：功能性行为评估以确定行为原因；社交、沟通和学术技能的结构化教学；使用积极强化来激励和维持期望的行为；数据收集以监控进展；将获得的技能泛化到不同环境。ABA治疗应该个体化，考虑每个人的具体需求。当由合格的专家实施时，它可以在沟通、社交互动、适应性行为和整体生活质量方面带来显著改善。';

  @override
  String get article_aba_therapy_author => '玛丽亚·桑托斯博士 - 行为分析师';

  @override
  String get article_routines_title => '日常对自闭症患者的重要性';

  @override
  String get article_routines_body =>
      '结构化的日常对自闭症患者的福祉至关重要，在一个可能显得混乱的世界中提供可预测性和安全感。日常的益处包括：通过可预测性减少焦虑；发展独立性和自主性；改善时间和空间组织；促进新技能学习；减少挑战性行为。实施有效日常的方法：使用视觉支持，如日历和时间表；保持时间和活动的一致性；提前为变化做准备；在日常中包含愉快的活动；在必要时保持灵活性，逐步引入变化。记住，每个人都有自己的需求和偏好。目标是创建一个促进发展和福祉的结构，而不是引起压力的僵化。';

  @override
  String get article_routines_author => '乔奥·奥利维拉教授 - 作业治疗师';

  @override
  String get article_school_inclusion_title => '学校融合：成功的策略';

  @override
  String get article_school_inclusion_body =>
      '自闭症学生的学校融合需要精心规划和具体策略来确保学术和社交成功。关键要素包括：具有清晰和可预测日常的结构化环境；尊重学生学习风格的课程适应；使用视觉和技术支持；通过指导活动发展社交技能；家庭、学校和专家之间的合作；对教师进行有关自闭症的持续培训。实用策略：为自我调节时刻创建安静空间；为日常活动使用视觉时间表；在必要时实施感觉休息；促进与同伴的积极社交互动；在必要时建立替代沟通系统。融合的成功取决于整个学校社区的承诺，创建一个适应每个学生个体需求的欢迎环境。';
  ...
  String get article_sensory_processing_body =>
      '许多自闭症患者在感觉处理方面存在差异，对环境刺激可能过度敏感或敏感度不足。';

  @override
  String get article_sensory_processing_author => '费尔南达·罗查博士 - 作业治疗师';

  @override
  String get article_family_support_title => '家庭支持：关爱照护者';

  @override
  String get article_family_support_body =>
      '自闭症患者的家庭面临独特的挑战，需要持续的支持。照护者的自我关爱对整个家庭的福祉至关重要。';

  @override
  String get article_family_support_author => '比亚特丽斯·阿尔梅达博士 - 家庭心理学家';

  @override
  String get article_communication_strategies_title => '有效沟通策略';

  @override
  String get article_communication_strategies_body =>
      '与自闭症谱系人群的沟通可以通过尊重他们需求和偏好的具体策略来促进。';

  @override
  String get article_communication_strategies_author => '帕特里夏·门德斯博士 - 语言治疗师';
}
