...
abstract class AppLocalizations {
  ...
  /// No description provided for @routine_of.
  ///
  /// In pt_BR, this message translates to:
  /// **'Rotina de %s'**
  String get routine_of;

  /// No description provided for @support_level.
  ///
  /// In pt_BR, this message translates to:
  /// **'Suporte %s'**
  String get support_level;
  ...
  /// No description provided for @connection_error_detail.
  ///
  /// In pt_BR, this message translates to:
  /// **'Erro de conexão: %s'**
  ...
  ///
  /// In pt_BR, this message translates to:
  /// **'Erro ao deletar post: %s'**
  String get error_deleting_post;
  ...
  /// No description provided for @change_name_to.
  ///
  /// In pt_BR, this message translates to:
  /// **'Alterar nome para \"%s\"?'**
  String get change_name_to;

  /// No description provided for @change_username_to.
  ///
  /// In pt_BR, this message translates to:
  /// **'Alterar username de @%s para @%s?'**
