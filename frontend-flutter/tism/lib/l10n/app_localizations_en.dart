...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get routine_of => '%s\'s Routine';

  @override
  String get support_level => '%s Support';
  ...
  @override
  String get progress_count => 'Progress: %d/%d';
  ...
  @override
  String get connection_error_detail => 'Connection error: %s';
  ...
  @override
  String get error_deleting_post => 'Error deleting post: %s';
  ...
  @override
  String get intensity => 'Intensity: %d';
  ...
  @override
  String get change_name_to => 'Change name to \"%s\"?';

  @override
  String get change_username_to => 'Change username from @%s to @%s?';
